...
/** Use block editor only for pages and posts */
...
function sp_acf_register_assets()
{
    ...
    if ($should_enqueue_style) {
        ...
        $style_file = get_template_directory() . '/assets/css/acf-styles.css';
        
        if (file_exists($style_file)) {
            wp_enqueue_style('acf_styles', $style_path, false, filemtime($style_file));
        } else {
            error_log('ACF styles file not found: ' . $style_file);
        }
    }
